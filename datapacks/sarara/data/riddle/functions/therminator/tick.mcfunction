...
execute if entity @e[type=minecraft:snowball,x=-526,y=30,z=-90,dx=7,dy=1,dz=-12] if score condition therminator matches 0 run execute as @a[x=-526,y=30,z=-90,distance=..10] at @s run playsound item.bucket.fill master @s ~ ~ ~ 1.0 1.0 1.0
...
execute if entity @e[type=minecraft:snowball,x=-526,y=30,z=-90,dx=7,dy=1,dz=-12] if score condition therminator matches 1 run execute as @a[x=-526,y=30,z=-90,distance=..10] at @s run playsound item.bucket.fill master @s ~ ~ ~ 1.0 0.5 1.0
