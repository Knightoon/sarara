...
execute if score @e[type=villager,tag=bad_1,limit=1] talk matches 0 if score @e[type=villager,tag=bad_1,limit=1] talk_time matches 10 run scoreboard players set @e[type=villager,tag=bad_1] talk_on 0
execute if score @e[type=villager,tag=bad_1,limit=1] talk matches 0 if score @e[type=villager,tag=bad_1,limit=1] talk_time matches 10 run scoreboard players set @e[type=villager,tag=bad_1] talk_time 0
execute if score @e[type=villager,tag=bad_1,limit=1] talk matches 1 if score @e[type=villager,tag=bad_1,limit=1] talk_time matches 10 run scoreboard players set @e[type=villager,tag=bad_1] talk_on 100
execute if score @e[type=villager,tag=bad_1,limit=1] talk matches 1 if score @e[type=villager,tag=bad_1,limit=1] talk_time matches 10 run scoreboard players set @e[type=villager,tag=bad_1] talk_time 0
